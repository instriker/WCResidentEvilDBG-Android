...
import com.instriker.wcre.presentation.MainViewModel
import com.instriker.wcre.presentation.ServiceLocator

class MainActivity : RedbgcActivity() {
    protected override val initialLayout: Int
        get() = com.instriker.wcre.R.layout.activity_main

    override fun createViewModel(): RedbgcViewModel {
        return MainViewModel(ServiceLocator(this))
    }
}
