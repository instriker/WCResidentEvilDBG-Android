...
import com.instriker.wcre.presentation.SettingsViewModel

class SettingsActivity : RedbgcActivity() {
    protected override val initialLayout: Int
        get() = com.instriker.wcre.R.layout.activity_settings

    override fun createViewModel(): RedbgcViewModel {
        return SettingsViewModel(ServiceLocator(this))
    }
}
